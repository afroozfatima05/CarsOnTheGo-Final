...
<nav class="navbar navbar-inverse" margin-bottom:10px>
 ...
 #navbar{
margin:8px;border-radius:15px;font-size:150%;}
...
<body>
<nav class="navbar navbar-inverse" style="backgroud-color: pink;">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <li><a href="CustomerCheck">Login</a></li>
        ...
        <li class="current icon"><a href="/shoeclue"><img src="resources/images/logoex.png" alt="" width="150" height="60"></a></li>
		  <li>&nbsp; &nbsp; &nbsp; &nbsp;</li>
		   ...
		   <li> <button type="button" class="btn btn-default btn-m" style="background-color:red"></button></li>
		    <li>&nbsp; &nbsp; &nbsp; &nbsp;</li>
...
<div class="carousel-caption">
  ...
  <img src="resources/images/car3.jpg"  style="width: 800px; height: 400px">
 ...
 <img src="resources/images/car4.jpg"  style="width: 800px; height: 400px">
  ...
  <div class="carousel-caption">
   ...
   <img src="resources/images/car5.jpg"  style="width: 800px; height: 400px">
 ...
 <div class="item">
    ...
    <img src="resources/images/car6.jpg" style="width: 800px; height: 400px">
