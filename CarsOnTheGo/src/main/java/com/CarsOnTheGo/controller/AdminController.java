...
import com.CarsOnTheGo.model.Item;
import com.CarsOnTheGo.service.UsersDetailService;
import com.CarsOnTheGo.service.ItemDaoService;
@Controller
...
public String logout(HttpServletRequest request)
{
	...
	public String storeProduct(HttpServletRequest request,ModelMap model,@RequestParam("file") MultipartFile file, @Valid @ModelAttribute("shoes") Item p,BindingResult result)
	{
    	...
    	productService.addProduct(p);
         ...
         path = Paths.get("D://DAILY CLASSES//CarsOnTheGo//CarsOnTheGo//src//main//webapp//resources//images//"+p.getProduct_id()+".jpg");
System.out.println();
 ...
 BufferedOutputStream buffStream = new BufferedOutputStream(new FileOutputStream(new File("H:/spring framework/project1/CarsOnTheGo/src/main/webapp/resources/images/" + fileName)));
    	...
    	File oldName = new File("H:/spring framework/project1/CarsOnTheGo/src/main/webapp/resources/images/" + fileName);
        File newName = new File("H:/spring framework/project1/CarsOnTheGo/src/main/webapp/resources/images/" + p.getProduct_id()+fileName.substring(fileName.indexOf(".")));
